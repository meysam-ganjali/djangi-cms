...
class BlogAdmin(admin.ModelAdmin):
    list_display = (
    'title', 'slug', 'get_blog_img', 'created_at', 'pub_date', 'is_published', 'is_active', 'show_seo', 'show_tag')
    inlines = [BlogSeoInstanceAdminInline, BlogtagInstanceAdminInline]
    ordering = ('-pub_date', 'title')
    prepopulated_fields = {'slug': ('title',)}  # This should populate 'slug' from 'title'
